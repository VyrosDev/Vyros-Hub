...
local speedMap = {
    ["x150"] = 100,  -- Metade da força atual
    ["x200"] = 150,
    ["x300"] = 300
}
...
--// Demonnic Hub UI \\--
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/DemonnicHub/VyrosxC/refs/heads/main/OrionUI.lua')))()
...
Tab:AddToggle({
    ...
    Callback = function(state)
        isCollecting = state
        print("Estado do Auto Farm: " .. (isCollecting and "Ativado" or "Desativado"))
...
Tab:AddButton({
    Name = "Delete Barriers (Main City)",
    Callback = function()
        deleteBarrier() 
    end    
})
