...
function MakeScriptHub()
         loadstring(game:HttpGet('https://raw.githubusercontent.com/Ck_Vyros/Vyros-Hub/main/HubLoader.lua'))() --Put The Script That Will Load If The Key Is Correct Here
end
